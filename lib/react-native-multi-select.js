...
export default class MultiSelect extends Component {
  static propTypes = {
    ...
    hideSelectorToggle: PropTypes.bool
  };
  ...
  componentDidUpdate(prevProps) {
    if (this.props.hideSelectorToggle !== prevProps.hideSelectorToggle) {
  ...
  _getSelectLabel = () => {
    ...
    const selectLabel = selectedText?`${selectText} (${selectedItems.length} ${selectedText})`:selectText;
    return selectLabel;
  };
  ...
  _toggleSelector = () => {
    ...
    if (onToggleList) {
      onToggleList(this.state.selector);
    }
  };
